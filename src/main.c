...
const char	title[52] = "Alt. [DreamShell BootLoader] CyrusDevX | Ver-"VERSION" |";
...
int main(int argc, char **argv) {
	...
	} else if(flashrom_get_region_only() == FLASHROM_REGION_US) {
...
//	InitSDCard();
	...
	*/
	...
	pvr_set_bg_color(168.0/255.0, 168.0/255.0, 168.0/255.0);
